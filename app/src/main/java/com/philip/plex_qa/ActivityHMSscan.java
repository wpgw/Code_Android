...
public class ActivityHMSscan extends AppCompatActivity {
    ...
    private static final String TAG = "ActivityHMSscan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_m_sscan);
    ...
    private void setPictureScanOperation() {
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityHMSscan.this.startActivityForResult(pickIntent, REQUEST_CODE_PHOTO);
    ...
    /**
     * Handle the return results from the album. （有从相册直接取照片扫描功能）
     */
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_CODE_PHOTO) {
            try {
                ...
                HmsScan[] hmsScans = ScanUtil.decodeWithBitmap(ActivityHMSscan.this, bitmap, new HmsScanAnalyzerOptions.Creator().setPhotoMode(true).create());
